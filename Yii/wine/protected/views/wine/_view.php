...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->wine_id), array('view', 'id'=>$data->wine_id)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('vintage')); ?>:</b>
	<?php echo CHtml::encode($data->vintage); ?>
	<br />
